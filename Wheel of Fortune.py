## This is python project for creating a simplified wheel of Fortune in Python.
    ...
    def getMove(self, category, obscuredPhrase, guessed):
        ...
        if g == []:
            ...
            if self.smartCoinFlip() == True:
                l = sorted(g, key = lambda a:[SORTED_FREQUENCIES.index(x) for x in a])
                return l[0]
            else:
